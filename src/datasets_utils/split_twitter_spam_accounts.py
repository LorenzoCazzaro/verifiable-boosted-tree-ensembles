...
folder_path = "../../datasets/twitter_spam_accounts"
...
data = pd.read_csv("../../datasets/twitter_spam_accounts/dataset/social_honeypot.train.csv").to_numpy()
...
#load test dataset
data = pd.read_csv("../../datasets/twitter_spam_accounts/dataset/social_honeypot.test.csv").to_numpy()
X = data[:, 1:].astype(float)
y = data[:, 0].astype(str)
y[y=='0'] = 0
y[y=='1'] = 1
